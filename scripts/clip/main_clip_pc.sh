...
# bash scripts/clip/main_clip_pc.sh pacs RN50 0
# bash scripts/clip/main_clip_pc.sh vlcs RN50 1
# bash scripts/clip/main_clip_pc.sh office_home RN50 3
# bash scripts/clip/main_clip_pc.sh domainnet RN50 0

# bash scripts/clip/main_clip_pc.sh pacs ViT-B/16 0
# bash scripts/clip/main_clip_pc.sh vlcs ViT-B/16 2
# bash scripts/clip/main_clip_pc.sh office_home ViT-B/16 4
# bash scripts/clip/main_clip_pc.sh domainnet ViT-B/16 0
